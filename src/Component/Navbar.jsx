  ...
  <nav className="sm:w-[80%] w-[100%] fixed z-20 bg-gray-800 px-2 py-2 flex justify-end gap-8 sm:gap-0 sm:justify-between items-center">
    ...
    <div className=' flex gap-2 sm:gap-4 justify-end items-center'>
      <div className="relative  mt-1">
        <div className="absolute left-0 top-0 bg-red-600 rounded-full">
          <span className="text-sm text-white p-1">{number}</span>
        </div>
        <div className="p-2">
          <svg
      ...
      <button className="bg-gray-800 focus:bg-red-700 border-2 border-white font-mono px-1 text-indigo-200 font-bold  rounded-sm hover:bg-indigo-800">
        Logout
      </button>
    </div>
